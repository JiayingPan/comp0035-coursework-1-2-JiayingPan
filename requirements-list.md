...
| 11 | Commutor | As a website user, I hope there is a chat feature so I can communicate and discuss with other users. | <ul><li>The comment box displays under the visualisation charts <li>Sent email if any posted comment is replied by other users | Could have |  
