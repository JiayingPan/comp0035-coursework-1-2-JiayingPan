...
| 10 | Commutor | As a website user, I hope there is a ‘lift to top’ option, even if I add attention to the air quality in many places, I can still put the data of my resident place on the top and find it quickly. | <ul><li>The system uses a list comprehension to reorder the location list | Won't have for now |  
| 11 | Commutor | As a website user, I hope there is a chat feature so I can communicate and discuss with other users. | <ul><li>The comment box displays under the visualisation charts <li>Sent email if any posted comment is replied by other users | Should have |  
| 12 | Environmentalist | As a website user, I hope that the content of this app can add some scrolls calling for everyone to protect the environment. | <ul><li>The system has a slogan library <li>The system randomly select a slogan from the library <li>The slogan displays at the top of the app home page | Won't have for now |  
...
| 16 | Air quality specialist | As a website user, I want to compare the data throughout a month so that I can find the law of change. | <ul><li>The system displays the monthly air pollutants value charts by selecting month as time period in the visulisation page | Should have |  
