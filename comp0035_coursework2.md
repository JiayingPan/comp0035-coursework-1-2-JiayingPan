...
### Tests
The test is around the 'User' class, therefore the User module is saved in a python package named Air_quality, with python files [user.py](Air_quality/user.py) in it to write tests code for the module.
