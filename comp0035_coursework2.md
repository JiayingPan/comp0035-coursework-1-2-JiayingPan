...
General public that cosisting of the target audience of the web app (external users):
...
| 11 | Commutor | As a website user, I want the web app can have a forum, so that I can get feedback from users directly and make improvements. | <ul><li>The link of the forum displays at the corner of the main interface <li>Forum invitation email sents to every account monthly | Could have|  
...
Staffs for the developement purpose of the web app (internal users):
| No. | Persona | User Stories | Acceptance Criteria |  Priority  | 
| :---: | :---: |--- | --- | :---: |
